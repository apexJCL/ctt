...
<div>
    ...
    <!-- Inventarios -->
    <div class="container-fluid greedy-vertical-300 grey darken-3 white-text scrollspy" id="inventory">
        <div class="container">
            <div class="row">
    ...
    <div class="scrollspy" id="reservations">
        <div class="parallax-container" style="background-color: rgba(41, 103, 155, 0.4);">
            <div class="container greedy-verticall-300">
                <h1 class="raleway-bold white-text">
                    <div class="thin-line white"></div>
                    Reservaciones
                </h1>
    ...
    <!-- Contacto -->
    <div class="container-fluid padding-bottom-20 white" id="support">
        <div class="container">
            <h1 class="raleway-bold">
                <div class="thin-line blue darken-1"></div>
                Soporte
